 ...
 * "tests/func_tests/tests_check/test_parse_format.c" instead.
 */
...
START_TEST(test_parse_format_normal_data) {
  ...
  ck_assert_msg(
      ...
      "%d]\n"
      "[length_L: %d ----- %d]",
      data[_i].input.format_str, width, precision, s21_options->spec,
      expected_output->spec, format_str, data[_i].output.expected_output_str,
      s21_options->width, expected_output->width, s21_options->precision,
      expected_output->precision, s21_options->flag[0],
      expected_output->flag[0], s21_options->flag[1], expected_output->flag[1],
      s21_options->flag[2], expected_output->flag[2], s21_options->flag[3],
      expected_output->flag[3], s21_options->flag[4], expected_output->flag[4],
...
int test_parse_format(void) {
  Suite *s1 = suite_create("parse_format");
  TCase *tc1_1 = tcase_create("parse_format");
  ...
  tcase_add_loop_test(tc1_1, test_parse_format_normal_data, 0, 36);
